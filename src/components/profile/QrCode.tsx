    ...
    <div className="bg-white p-4 flex flex-col  gap-[16px] rounded-2xl w-auto">
      ...
      {showQr ? (
        <>
          ...
          <div className="self-center max-w-[358px] w-[90%]  bg-gray-500 flex justify-center items-center bg-gradient-to-r from-[#D20653] to-[#FF951D] rounded-2xl ">
            <div className="p-2 flex flex-col justify-between w-[85%] mt-4 mb-4 items-center rounded-3xl bg-white">
              <Link href={"/"}>
                <Image
